...
export const CAMPING_LIEUX = [
  ...
  { id: 'sanitaires',   label: 'Sanitaires',          emoji: '🚿', color: '#6b7280', keywords: ['toilet','sanitaire','wc','shower','douche','bloc sanitaire','restroom'] },
  { id: 'laverie',      label: 'Laverie',             emoji: '🧺', color: '#6b7280', keywords: ['laundry','laverie','wash','linge'] },
